...
function Softkeys__(props: {
	...
	const [previous, setPrevious] = createSignal<null | Readonly<[string, string, string, boolean]>>(
		null
	);
	const [softkeys, setSoftkeys] = createSignal<Readonly<[string, string, string, boolean]>>([
		props.left || "",
		props.center || "",
		props.right || "",
		Boolean(props.black),
